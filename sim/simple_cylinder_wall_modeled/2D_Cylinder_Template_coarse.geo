...
Transfinite Curve {21, 22, 23, 24} = 8 Using Progression 1.105;

// BOT VERTICAL EDGES GOING LEFT TO RIGHT 
Transfinite Curve {26, 27, 28, 29} = 8 Using Progression 1.105;

// LEFT HORIZONTAL EDGES GOING TOP TO BOTTOM
Transfinite Curve {32, 36, 39, 41} = 8 Using Progression 0.9;

// RIGHT HORIZONTAL EDGES GOING TOP TO BOTTOM
Transfinite Curve {35, 37, 40, 43} = 35 Using Progression 1.01;
...
Transfinite Curve {30, 18} = 26 Using Bump 1.0;
Transfinite Curve {6, 2} = 26 Using Progression 1.0;

// DOWNSTREAM REGION (going away from cyl surface)
Transfinite Curve {8, 4} = 26 Using Progression 1.0;
Transfinite Curve {17, 31} = 26 Using Bump 1.0;

// RADIALLY FROM CYLINDER IN BL
//Transfinite Curve {9, 10, 11, 12} = 27 Using Progression 1.25;
Transfinite Curve {9, 10, 11, 12} = 6 Using Progression 2.9;

// RADIALLY FROM CYLINDER OUTSIDE BL 
Transfinite Curve {13, 14, 15, 16} = 15 Using Progression 1.05;


// OVERHEAD REGION
Transfinite Curve {34, 19, 5, 1} = 26 Using Progression 1.0;
Transfinite Curve {42, 20, 7, 3} = 26 Using Progression 1.0;
